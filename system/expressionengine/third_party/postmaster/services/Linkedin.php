 ...
 * LinkedIn
 *
 * Allows you to post notifications to LinkedIn
...
class Linkedin_postmaster_service extends Base_service {
	...
	public $description = 'Post notifications to LinkedIn. Social Update must be installed and configured.';
	...
	public function __construct()
	{
        ...
        //if yes, fetch names of LinkedIn accounts
	...
	{		
        ...
        $this->EE->load->library('linkedin_oauth', $post_params);

        $remote_post = $this->EE->linkedin_oauth->post(
			$message, 
