 ...
 * Twitter
 *
 * Allows you to post notifications to Twitter
...
class Twitter_postmaster_service extends Base_service {
	...
	public $description = 'Post notifications to Twitter. Social Update must be installed and configured.';
	...
	public function __construct()
	{
        ...
        //if yes, fetch names of Twitter accounts
	...
	{		
        ...
        $this->EE->load->library('twitter_oauth', $post_params);

        $remote_post = $this->EE->twitter_oauth->post(
			$message, 
